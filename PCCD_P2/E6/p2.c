...
int main(int argc, char* argv[]){
    ...
    switch(pid_Ramos=fork()){
        case 0:
            if(execl("p2_hijo", "Ramos", (char *) NULL) == -1) exit(-1);
    ...
    switch(pid_Carvajal=fork()){
        case 0:
            if(execl("p2_hijo", "Carvajal", (char *) NULL) == -1) exit(-1);
    ...
    switch(pid_Pique=fork()){
        case 0:
            if(execl("p2_hijo", "Pique", (char *) NULL) == -1) exit(-1);
    ...
    switch(pid_Isco=fork()){
	    case 0:  
            if(execl("p2_hijo", "Isco Thiago", (char *) NULL) == -1) exit(-1);
