...
//Definimos la variable K, procesos escritores que pueden adelantar
int N1, N2, N3, K, escritura, lectura = 0;

// Invocación: p7 N1 N2 N3 K
// N1: numero total de lectores
// N2: numero total de lectores simultáneos en el papel
// N3: numero total de escritores
// K:  numero de procesos escritores que pueden adelantar a un lector
